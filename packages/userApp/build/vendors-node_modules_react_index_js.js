"use strict";
(self["webpackChunkuserApp"] = self["webpackChunkuserApp"] || []).push([["vendors-node_modules_react_index_js"],{
 ...
 *
 * The current owner is the component who should own any ui that are
...
function createElementWithValidation(type, props, children) {
  ...
  if (!validType) {
    ...
    {
      error('React.createElement: type is invalid -- expected a string (for ' + 'built-in ui) or a class/function (for composite ' + 'ui) but got: %s.%s', typeString, info);
    }
  }

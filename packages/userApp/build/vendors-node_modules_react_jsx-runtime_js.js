"use strict";
(self["webpackChunkuserApp"] = self["webpackChunkuserApp"] || []).push([["vendors-node_modules_react_jsx-runtime_js"],{
...
function testStringCoercion(value) {
  ...
  // ancestor ui where the exception happened.
  //
  // eslint-disable-next-line react-internal/safe-string-coercion
  return '' + value;
}
...
function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
  {
    ...
    if (!validType) {
      ...
      error('React.jsx: type is invalid -- expected a string (for ' + 'built-in ui) or a class/function (for composite ' + 'ui) but got: %s.%s', typeString, info);
    }
